<template>
  ...
  <div class="bg-clean-white rounded-t-2xl px-4 md:pt-16 md:pr-16 md:pl-0 relative  ">
    <div class="container mx-auto">
      <div class="relative   " >
        <!-- Left: Image with Triangle Overlay (overlapping from above) -->
        <div class=" left-0 top-0 max-w-[80vw] hidden md:block w-full md:w-[80%] mr-10 ">
        ...
        <!-- Right: Text and Button (overlapping on top) -->
        <div
          class="md:absolute right-0 top-0 md:top-[20%] w-full md:w-auto md:max-w-[40%] z-30">
          <div class="space-y-6 z-20 py-10 md:py-6">
            <h5 class="text-h5 md:text-end text-midnight-blue whitespace-pre-line">
              {{ $t('mission.statueHeading') }}
            </h5>
