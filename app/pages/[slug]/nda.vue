<template>
  <div class="min-h-screen bg-midnight-blue flex flex-col">
    ...
    >
      ...
      <div class="relative z-10 flex items-center justify-center min-h-screen px-4 pt-24">
        <div class="w-full container">
          ...
          <div class="bg-midnight-blue opacity-70 rounded-[24px] p-8 md:p-12 shadow-2xl">
            ...
            <div v-else-if="fetchError" class="text-center py-8">
              <p class="text-clean-white/80 text-sm">{{ $t('corporate.error.generic') }}</p>
            </div>
            ...
            <template v-else-if="corporateData">
              ...
              <!-- Description -->
              <p class="text-clean-white/80 text-sm text-center leading-relaxed mb-2">
              ...
              <p class="text-clean-white/70 text-sm text-center leading-relaxed mb-8">
              ...
              <label class="flex items-start gap-3 mb-8 cursor-pointer group">
                <div
                  ...
                  :class="accepted ? 'border-lemon bg-lemon' : 'border-clean-white/40 bg-transparent group-hover:border-clean-white/70'"
              ...
              <div class="mt-6 text-center space-y-1">
                <p class="text-clean-white/40 text-[11px]">{{ $t('corporate.card.statusLine1') }}</p>
                <p class="text-clean-white/40 text-[11px]">{{ $t('corporate.card.statusLine2') }}</p>
              </div>
            </template>
